...
const taskSeedVersion = 'task-updates-2026-09-14-v1';
...
const requiredTaskSeeds: Task[] = [
  ...
  },
  {
    ...
    description: 'План на неделю 14.09-20.09: разместить на сайте актуальные изображения на E-E-A-T страницах.',
    status: 'active',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-14',
    deadline: '2026-09-20',
