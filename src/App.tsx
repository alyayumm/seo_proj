...
const initialProjects: Project[] = [
  ...
  { id: 'project-seo-general', name: 'Общее', color: '#D8EEF3' },
...
const taskSeedVersion = 'task-updates-2026-09-21-plans-v1';
...
const requiredTaskSeeds: Task[] = [
  ...
  },
  {
    ...
    description: 'На 14.09: план работ на 3 месяца составлен.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-08-24',
    deadline: '2026-09-13',
  ...
  },
  {
    ...
    projectId: 'project-aquaguard',
    title: 'Наполнение сайта и фида товарами',
    description: 'План на неделю 21.09-27.09: наполнять сайт и фид товарами.',
    status: 'active',
    ownerIds: ['person-olga', 'person-aleksey'],
  ...
  },
  {
    ...
    description: 'На 14.09: блог запущен, публикация статей настроена.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-07',
    deadline: '2026-09-13',
  ...
  },
  {
    ...
    description: 'На 14.09: контент-план для блога составлен.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-07',
    deadline: '2026-09-13',
  ...
  },
  {
    ...
    projectId: 'project-watch',
    title: 'Настроить публикацию статей',
    description: 'План на неделю 21.09-27.09: настроить публикацию статей на WatchStore.',
    status: 'active',
    ownerIds: ['person-outsource'],
    createdAt: '2026-09-07',
    deadline: '2026-09-27',
  ...
  },
  {
    ...
    projectId: 'project-watch',
    title: 'Контент план по статьям',
    description: 'На 14.09: контент-план подготовлен.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-07',
    deadline: '2026-09-13',
  ...
  },
  {
    ...
    description:
      'На 14.09: исправлен импорт текстов в блог, внесены текстовые правки, визуал и верстка.',
  ...
  },
  {
    ...
    projectId: 'project-promteh',
    title: 'Недельная запись 31.08: Промтех',
    description: 'Сделано за неделю по Промтеху.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-08-31',
    deadline: '2026-08-31',
  ...
  },
  {
    ...
    projectId: 'project-smart',
    title: 'Недельная запись 31.08: Смартстрой',
    description: 'Сделано за неделю по Смартстрою.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-08-31',
    deadline: '2026-08-31',
  ...
  },
  {
    ...
    projectId: 'project-aquaguard',
    title: 'Недельная запись 31.08: Аквагард',
    description: 'Сделано за неделю по Аквагарду.',
    status: 'done',
  ...
  },
  {
    ...
    projectId: 'project-balt-pallet',
    title: 'Недельная запись 31.08: Балт Паллет',
    description: 'Сделано за неделю по Балт Паллет.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-08-31',
    deadline: '2026-08-31',
  ...
  },
  {
    ...
    projectId: 'project-watch',
    title: 'Недельная запись 31.08: Часы',
    description: 'Сделано за неделю по Часам.',
    status: 'done',
    ownerIds: ['person-outsource'],
    createdAt: '2026-08-31',
    deadline: '2026-08-31',
  ...
  },
  {
    ...
    projectId: 'project-balt-pallet',
    title: 'Недельная запись 07.09: Балт Паллет',
    description: 'Сделано за неделю 31.08-06.09 по Балт Паллет.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-07',
    deadline: '2026-09-07',
  ...
  },
  {
    ...
    projectId: 'project-watch',
    title: 'Недельная запись 07.09: Часы',
    description: 'Сделано за неделю 31.08-06.09 по WatchStore.',
    status: 'done',
    ownerIds: ['person-outsource'],
    createdAt: '2026-09-07',
    deadline: '2026-09-07',
  ...
  },
  {
    ...
    projectId: 'project-smart',
    title: 'Недельная запись 07.09: Смартстрой',
    description: 'Сделано за неделю 31.08-06.09 по Смартстрою.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-07',
    deadline: '2026-09-07',
  ...
  },
  {
    ...
    projectId: 'project-aquaguard',
    title: 'Недельная запись 07.09: Аквагард',
    description: 'Сделано за неделю 31.08-06.09 по Аквагарду.',
    status: 'done',
    ownerIds: ['person-aleksey', 'person-olga'],
    createdAt: '2026-09-07',
    deadline: '2026-09-07',
  ...
  {
    id: 'weekly-balt-pallet-report-2026-09-14',
    projectId: 'project-balt-pallet',
    title: 'Недельная запись 14.09: Балт Паллет',
    description: 'Сделано за неделю 07.09-13.09 по Балт Паллет.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    ...
    timeline: [
      {
        id: 'timeline-balt-article-publishing-14-09',
        title: 'Настроить публикацию статей',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-14',
      ...
      {
        id: 'timeline-balt-sitemap-update-14-09',
        title: 'Настроить обновление sitemap',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-14',
        completedAt: '2026-09-14',
      ...
      {
        id: 'timeline-balt-microdata-14-09',
        title: 'Реализовать микроразметку',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-14',
        completedAt: '2026-09-14',
      ...
      {
        id: 'timeline-balt-visual-mobile-desktop-14-09',
        title: 'Исправить визуал и функционал десктоп и мобильной версии',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-14',
        completedAt: '2026-09-14',
      ...
      {
        id: 'timeline-balt-internal-linking-14-09',
        title: 'Реализовать блоки перелинковки',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-14',
        completedAt: '2026-09-14',
  ...
  {
    id: 'weekly-aquaguard-report-2026-09-14',
    projectId: 'project-aquaguard',
    title: 'Недельная запись 14.09: Аквагард',
    description: 'Сделано за неделю 07.09-13.09 по Аквагарду.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-14',
    deadline: '2026-09-14',
    ...
    timeline: [
      {
        id: 'timeline-aquaguard-thanks-letters-14-09',
        title: 'Реализовать блок с благодарственными письмами',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-14',
        completedAt: '2026-09-14',
  ...
  {
    id: 'weekly-rectop-report-2026-09-14',
    projectId: 'project-rectop',
    title: 'Недельная запись 14.09: Ректоп',
    description: 'Сделано за неделю 07.09-13.09 по Ректопу.',
    status: 'done',
    ownerIds: ['person-outsource'],
    createdAt: '2026-09-14',
    deadline: '2026-09-14',
    ...
    timeline: [
      {
        id: 'timeline-rectop-blog-import-14-09',
        title: 'Исправить импорт текстов в блог',
        ownerId: 'person-outsource',
        status: 'done',
        dueDate: '2026-09-14',
        completedAt: '2026-09-14',
      ...
      {
        id: 'timeline-rectop-text-corrections-14-09',
        title: 'Внести текстовые правки',
        ownerId: 'person-outsource',
        status: 'done',
        dueDate: '2026-09-14',
        completedAt: '2026-09-14',
  ...
  {
    id: 'weekly-watch-report-2026-09-14',
    projectId: 'project-watch',
    title: 'Недельная запись 14.09: Часы',
    description: 'Сделано за неделю 07.09-13.09 по WatchStore.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-14',
    deadline: '2026-09-14',
    ...
    timeline: [
      {
        id: 'timeline-watch-metatag-masks-14-09',
        title: 'Подготовить маски для автоформирования метатегов товаров',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-14',
        completedAt: '2026-09-14',
  ...
  {
    id: 'plan-rectop-page-structure-2026-09-14',
    projectId: 'project-rectop',
    title: 'Реализовать структуру страниц',
    description: 'План на неделю 14.09-20.09: реализовать структуру страниц по Ректопу.',
    sourceLabel: 'ТЗ правки',
    sourceUrl: RECTOP_CORRECTIONS_BRIEF_URL,
    status: 'active',
    ownerIds: ['person-outsource'],
  ...
  },
  {
    ...
    description: 'План на неделю 21.09-27.09: заполнить страницы контентом.',
    sourceLabel: 'ТЗ правки',
    sourceUrl: RECTOP_CORRECTIONS_BRIEF_URL,
    status: 'planned',
    ownerIds: ['person-outsource'],
  ...
  {
    id: 'plan-rectop-service-pages-2026-09-21',
    projectId: 'project-rectop',
    title: 'Создать сервисные страницы',
    description: 'План на неделю 21.09-27.09: создать сервисные страницы по Ректопу.',
    sourceLabel: 'ТЗ правки',
    sourceUrl: RECTOP_CORRECTIONS_BRIEF_URL,
    status: 'active',
    ownerIds: ['person-aleksey', 'person-outsource'],
  ...
  {
    id: 'plan-rectop-seo-requirements-2026-09-14',
    projectId: 'project-rectop',
    title: 'Реализовать SEO-требования',
    description: 'План на неделю 14.09-20.09: внедрить SEO-требования по структуре и страницам.',
    sourceLabel: 'ТЗ правки',
    sourceUrl: RECTOP_CORRECTIONS_BRIEF_URL,
    status: 'active',
    ownerIds: ['person-aleksey', 'person-outsource'],
  ...
  {
    id: 'plan-aquaguard-delivery-page-2026-09-14',
    projectId: 'project-aquaguard',
    title: 'Реализовать страницу про доставку',
    description: 'План на неделю 21.09-27.09: сделать отдельную страницу про доставку.',
    status: 'planned',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-14',
    deadline: '2026-09-27',
  ...
  {
    id: 'plan-aquaguard-official-brand-badge-2026-09-14',
    projectId: 'project-aquaguard',
    title: 'Модерация на значок официального бренда',
    description: 'План на неделю 21.09-27.09: пройти модерацию на значок официального бренда.',
    status: 'active',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-14',
    deadline: '2026-09-27',
  ...
  {
    id: 'plan-watch-parameters-db-2026-09-14',
    projectId: 'project-watch',
    title: 'Реализовать матрицу параметров в БД',
    description: 'План на неделю 21.09-27.09: реализовать матрицу параметров в базе данных.',
    status: 'active',
    ownerIds: ['person-outsource'],
    createdAt: '2026-09-14',
    deadline: '2026-09-27',
  ...
  {
    id: 'plan-watch-auto-metatags-2026-09-14',
    projectId: 'project-watch',
    title: 'Реализовать автоформирование метатегов',
    description: 'План на неделю 21.09-27.09: внедрить автоформирование метатегов товаров.',
    status: 'active',
    ownerIds: ['person-outsource'],
    createdAt: '2026-09-14',
    deadline: '2026-09-27',
  ...
  {
    id: 'plan-watch-sitemap-update-2026-09-14',
    projectId: 'project-watch',
    title: 'Настроить обновление sitemap',
    description: 'План на неделю 21.09-27.09: настроить обновление sitemap.',
    status: 'active',
    ownerIds: ['person-outsource'],
    createdAt: '2026-09-14',
    deadline: '2026-09-27',
  ...
  {
    id: 'plan-smartstroy-project-filter-fixes-2026-09-14',
    projectId: 'project-smart',
    title: 'Исправить визуал и функционал фильтра проектов',
    description: 'План на неделю 21.09-27.09: исправить визуал и функционал фильтра проектов.',
    status: 'active',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-14',
    deadline: '2026-09-27',
  ...
  {
    id: 'plan-promteh-eeat-images-2026-09-14',
    projectId: 'project-promteh',
    title: 'Разместить актуальные изображения на E-E-A-T страницах',
    description: 'На 21.09: изображения на E-E-A-T страницах обновлены.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-14',
    deadline: '2026-09-20',
  ...
  {
    id: 'plan-balt-mobile-visual-fixes-2026-09-21',
    projectId: 'project-balt-pallet',
    title: 'Исправить визуал в мобильной версии',
    description: 'План на неделю 21.09-27.09: исправить визуал в мобильной версии сайта Балт Паллет.',
    status: 'active',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-21',
    deadline: '2026-09-27',
  ...
  {
    id: 'plan-switch-course-pages-2026-09-21',
    projectId: 'project-switch',
    title: 'Создать страницы курсов',
    description: 'План на неделю 21.09-27.09: создать страницы курсов по проекту Англ. онлайн / Свич.',
    status: 'active',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-21',
    deadline: '2026-09-27',
  ...
  {
    id: 'plan-general-client-reports-2026-09-21',
    projectId: 'project-seo-general',
    title: 'Клиентские отчеты',
    description: 'Общая задача на неделю 21.09-27.09: подготовить клиентские отчеты по SEO-проектам.',
    status: 'active',
    ownerIds: ['person-kristina'],
    createdAt: '2026-09-21',
    deadline: '2026-09-27',
  ...
  {
    id: 'plan-general-link-strategy-corrections-2026-09-21',
    projectId: 'project-seo-general',
    title: 'Коррекция ссылочных стратегий',
    description: 'Общая задача на неделю 21.09-27.09: скорректировать ссылочные стратегии по SEO-проектам.',
    status: 'active',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-21',
    deadline: '2026-09-27',
  ...
  {
    id: 'weekly-promteh-report-2026-09-21',
    projectId: 'project-promteh',
    title: 'Недельная запись 21.09: Промтех',
    description: 'Сделано за неделю 14.09-20.09 по Промтеху.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-21',
    deadline: '2026-09-21',
    ...
    timeline: [
      {
        id: 'timeline-promteh-eeat-images-21-09',
        title: 'Обновить изображения на E-E-A-T страницах',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-21',
        completedAt: '2026-09-21',
      ...
      {
        id: 'timeline-promteh-blog-articles-21-09',
        title: 'Добавить новые статьи в блог на публикацию',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-21',
        completedAt: '2026-09-21',
      ...
      {
        id: 'timeline-promteh-link-purchase-21-09',
        title: 'Закупка ссылок',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-21',
        completedAt: '2026-09-21',
  ...
  {
    id: 'weekly-balt-pallet-report-2026-09-21',
    projectId: 'project-balt-pallet',
    title: 'Недельная запись 21.09: Балт Паллет',
    description: 'Сделано за неделю 14.09-20.09 по Балт Паллет.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-21',
    deadline: '2026-09-21',
    ...
    timeline: [
      {
        id: 'timeline-balt-blog-articles-21-09',
        title: 'Добавить новые статьи в блог на публикацию',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-21',
      ...
      {
        id: 'timeline-balt-link-purchase-21-09',
        title: 'Закупка ссылок',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-21',
  ...
  {
    id: 'weekly-aquaguard-report-2026-09-21',
    projectId: 'project-aquaguard',
    title: 'Недельная запись 21.09: Аквагард',
    description: 'Сделано за неделю 14.09-20.09 по Аквагарду.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-21',
    deadline: '2026-09-21',
    ...
    timeline: [
      {
        id: 'timeline-aquaguard-blog-articles-21-09',
        title: 'Добавить новые статьи в блог на публикацию',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-21',
      ...
      {
        id: 'timeline-aquaguard-link-purchase-21-09',
        title: 'Закупка ссылок',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-21',
  ...
  {
    id: 'weekly-smartstroy-report-2026-09-21',
    projectId: 'project-smart',
    title: 'Недельная запись 21.09: Смартстрой',
    description: 'Сделано за неделю 14.09-20.09 по Смартстрою.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-21',
    deadline: '2026-09-21',
    ...
    timeline: [
      {
        id: 'timeline-smartstroy-blog-articles-21-09',
        title: 'Добавить новые статьи в блог на публикацию',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-21',
      ...
      {
        id: 'timeline-smartstroy-link-purchase-21-09',
        title: 'Закупка ссылок',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-21',
  ...
  {
    id: 'weekly-switch-report-2026-09-21',
    projectId: 'project-switch',
    title: 'Недельная запись 21.09: Свич',
    description: 'Сделано за неделю 14.09-20.09 по проекту Англ. онлайн / Свич.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-21',
    deadline: '2026-09-21',
    ...
    timeline: [
      {
        id: 'timeline-switch-blog-articles-21-09',
        title: 'Добавить новые статьи в блог на публикацию',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-21',
      ...
      {
        id: 'timeline-switch-link-purchase-21-09',
        title: 'Закупка ссылок',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-21',
  ...
  {
    id: 'weekly-lombard-report-2026-09-21',
    projectId: 'project-lombard',
    title: 'Недельная запись 21.09: Ломбард',
    description: 'Сделано за неделю 14.09-20.09 по Ломбарду.',
    status: 'done',
    ownerIds: ['person-aleksey'],
    createdAt: '2026-09-21',
    deadline: '2026-09-21',
    ...
    timeline: [
      {
        id: 'timeline-lombard-blog-articles-21-09',
        title: 'Добавить новые статьи в блог на публикацию',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-21',
      ...
      {
        id: 'timeline-lombard-link-purchase-21-09',
        title: 'Закупка ссылок',
        ownerId: 'person-aleksey',
        status: 'done',
        dueDate: '2026-09-21',
  ...
  {
    id: 'weekly-rectop-report-2026-09-21',
    projectId: 'project-rectop',
    title: 'Недельная запись 21.09: Ректоп',
    description: 'Сделано за неделю 14.09-20.09 по Ректопу.',
    status: 'done',
    ownerIds: ['person-outsource'],
    createdAt: '2026-09-21',
    deadline: '2026-09-21',
    ...
    timeline: [
      {
        id: 'timeline-rectop-text-corrections-21-09',
        title: 'Внести текстовые правки',
        ownerId: 'person-outsource',
        status: 'done',
        dueDate: '2026-09-21',
      ...
      {
        id: 'timeline-rectop-visual-layout-corrections-21-09',
        title: 'Внести правки по визуалу и верстке',
        ownerId: 'person-outsource',
        status: 'done',
        dueDate: '2026-09-21',
        completedAt: '2026-09-21',
  ...
  },
  {
    ...
    description: 'Отчет за август закрыт в недельной записи на 31.08.',
    status: 'done',
    ownerIds: ['person-kristina'],
    createdAt: '2026-08-10',
    deadline: '2026-08-25',
  ...
  },
  {
    ...
    description: 'Отчет за август и новый формат отчета закрыты в недельной записи на 31.08.',
    status: 'done',
...
function App() {
  ...
  useEffect(() => {
    setProjects((current) => {
      ...
      const currentNames = new Set(current.map((project) => normalizeProjectName(project.name)));
      const missingProjects = initialProjects.filter(
        (project) => !currentIds.has(project.id) && !currentNames.has(normalizeProjectName(project.name)),
      );
